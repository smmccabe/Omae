...
activeSkills = {//the list of all the skills in the entire game forever. Catalysis needs to never release any more skills ever after this
  ...
  alchemy:{name:"Alchemy", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:true},
  artificing:{name:"Artificing", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  banishing:{name:"Banishing", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  binding:{name:"Binding", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  counterspelling:{name:"Counterspelling", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  ritualspellcasting:{name:"Ritual Spellcasting", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  spellcasting:{name:"Spellcasting", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  summoning:{name:"Summoning", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
  disenchanting:{name:"Disenchanting", catalog: "magic", stat:"mag", rating:0, mod:0, max:6, defaultable:false},
...
var groupSkills = {
  ...
  biotech: {name:"Biotech", rating:0, skillsingroup:{1:"cybertechnology", 2:"firstaid",3:"medicine",4:"biotechnology"}},
...
var spellforms = {//list of all the spells
  ...
  combatsense: {name: "Combat Sense", category: "detection", spell: false, preparation: false, active: "passive", direction: "Psychic", type: m, range: "T", duration: "Sustain", drain: "F"},
  ...
  resistpain: {name: "Resist Pain", category: "health", spell: false, preparation: false, essence: false, type: m, range: "T", duration: "Permanent", drain: "F-4"},
...
var weapons = {
  //blades
  combataxe: {name: "Combat axe", active: false, category:"blades", skill:"blades", accuracy: 4, accmod: 0, reach: 2, damage: 5, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element:" ", ap:-4, avail:12, restrict:"Restricted", cost:4000, ref:{book:"SR5",page:"422,423"}},
  combatknife: {name: "Combat knife", active: false, category:"blades", skill:"blades", accuracy: 6, accmod: 0, reach: 0, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-3, avail:4, restrict:" ", cost:300, ref:{book:"SR5",page:"422,423"}},
  forearmsnapblades: {name: "Forearm snap-blades", active: false, category:"blades", skill:"blades", accuracy: 4, accmod: 0, reach: 0, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-2, avail:7, restrict:"Restricted", cost:200, ref:{book:"SR5",page:"422,423"}},
  katana: {name: "Katana", active: false, category:"blades", skill:"blades", accuracy: 7, accmod: 0, reach: 1, damage: 3, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-3, avail:9, restrict:"Restricted", cost:1000, ref:{book:"SR5",page:"422,423"}},
  knife: {name: "Knife", active: false, category:"blades", skill:"blades", accuracy: 5, accmod: 0, reach: 0, damage: 1, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-1, avail:0, restrict:" ", cost:10, ref:{book:"SR5",page:"422,423"}},
  polearm: {name: "Pole arm", active: false, category:"blades", skill:"blades", accuracy: 5, accmod: 0, reach: 3, damage: 3, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-2, avail:6, restrict:"Restricted", cost:1000, ref:{book:"SR5",page:"422,423"}},
  survivalknife: {name: "Survival knife", active: false, category:"blades", skill:"blades", accuracy: 5, accmod: 0, reach: 0, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-1, avail:0, restrict:" ", cost:100, ref:{book:"SR5",page:"422,423"}},
  sword: {name: "Sword", active: false, category:"blades", skill:"blades", accuracy: 6, accmod: 0, reach: 1, damage: 3, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:-2, avail:5, restrict:"Restricted", cost:500, ref:{book:"SR5",page:"422,423"}},
  //clubs
  club: {name: "Club", active: false, category:"clubs", skill:"clubs", accuracy: 4, accmod: 0, reach: 1, damage: 3, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:0, avail:0, restrict:" ", cost:30, ref:{book:"SR5",page:"422,423"}},
  extendablebaton: {name: "Extendable Baton", active: false, category:"clubs", skill:"clubs", accuracy: 5, accmod: 0, reach: 1, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:0, avail:4, restrict:" ", cost:100, ref:{book:"SR5",page:"422,423"}},
  sap: {name: "Sap", active: false, category:"clubs", skill:"clubs", accuracy: 5, accmod: 0, reach: 0, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:0, avail:2, restrict:" ", cost:30, ref:{book:"SR5",page:"422,423"}},
  staff: {name: "Staff", active: false, category:"clubs", skill:"clubs", accuracy: 6, accmod: 0, reach: 2, damage: 3, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:0, avail:3, restrict:" ", cost:100, ref:{book:"SR5",page:"422,423"}},
  stunbaton: {name: "Stun Baton", active: false, category:"clubs", skill:"clubs", accuracy: 4, accmod: 0, reach: 1, damage: 9, stat: 0, dvmod: 0, damtype: "Stun", element: "Electricity", ap:-5, avail:6, restrict:"Restricted", cost:750, ref:{book:"SR5",page:"422,423"}},
  telescopingstaff: {name: "Telescoping Staff", active: false, category:"clubs", skill:"clubs", accuracy: 4, accmod: 0, reach: 2, damage: 2, stat: attributes.current.str, dvmod: 0, damtype: "Physical", element: " ", ap:0, avail:4, restrict:" ", cost:350, ref:{book:"SR5",page:"422,423"}},
  //unarmed
  knucks: {name:"Knucks", active: false, category:"unarmedcombat", skill:"unarmedcombat", accuracy: attributes.limits.phyLimit, accmod:0, reach:0, damage:1, stat: attributes.current.str, dvmod:0, damtype: "Physical", element: " ", ap:0, avail:2, restrict:"Restricted", cost: 100, ref:{book:"SR5",page:"422,423"}},
  shockgloves: {name:"Shock Gloves", active: false, category:"unarmedcombat", skill:"unarmedcombat", accuracy: attributes.limits.phyLimit, accmod:0, reach:0, damage:8, stat: 0, dvmod:0, damtype: "Stun", element: "Electricity", ap:-5, avail:6, restrict:"Restricted", cost: 550, ref:{book:"SR5",page:"423"}},
  //exotic melee weapon
  monofilamentwhip: {name:"Monofilament Whip", active: false, category:"exoticmeleeweapon", skill:"monofilamentwhip", skillName:"Monofilament Whip", accuracy: 5, accmod: 2, reach:2, damage:12, stat: 0, dvmod:0, damtype: "Physical", element: " ", ap:-8, avail:12, restrict:"Forbidden", cost: 10000, ref:{book:"SR5",page:"423"}},
  monofilamentchainsaw: {name:"Monofilament Chainsaw", active: false, category:"exoticmeleeweapon", skill:"chainsaw", skillName:"Chainsaw", accuracy: 3, accmod: 0, reach:1, damage:8, stat: 0, dvmod:0, damtype: "Physical", element: " ", ap:-6, avail:8, restrict:"", cost: 500, ref:{book:"SR5",page:"448"}},
  //bow
  bow:{name:"Bow", active:false, rating: 1, category:"bow", skill:"archery", accuracy:6, accmod:0, damage:attributes.current.str+2, stat:0, dvmod:0, damtype: "Physical", element:" ", ap:-1, avail:1, restrict: " ",cost:100, ref:{book:"SR5",page:"423,424"}},
  //crossbow
  lightcrossbow: {name:"Light", active: false, category:"crossbow", skill:"archery", accuracy:7, accmod:0, damage:5, stat:0, dvmod:0, damtype: "Physical", element:" ", ap:-1, avail:2, restrict: " ",cost:300, ref:{book:"SR5",page:"424"}},
  mediumcrossbow: {name:"Medium", active: false, category:"crossbow", skill:"archery", accuracy:6, accmod:0, damage:7, stat:0, dvmod:0, damtype: "Physical", element:" ", ap:-2, avail:4, restrict: "Restricted",cost:500, ref:{book:"SR5",page:"424"}},
  heavycrossbow: {name:"Heavy", active: false, category:"crossbow", skill:"archery", accuracy:5, accmod:0, damage:10, stat:0, dvmod:0, damtype: "Physical", element:" ", ap:-3, avail:8, restrict: "Restricted",cost:1000, ref:{book:"SR5",page:"424"}},
  //throwing weapons
  shuriken: {name:"shuriken", active: false, category:"throwingweapons", skill:"throwingweapons", rating:0, accuracy: attributes.limits.phyLimit, accmod:0, damage:1, stat: attributes.current.str, dvmod:0, damtype: "Physical", element: " ", ap:-1, avail:4, restrict:"Restricted", cost: 25, ref:{book:"SR5",page:"424"}},
  ...
  //exoticrangedweapon
  aressiiisupersquirt: {name: "Ares S-III Super Squirt", active: false, category: "exoticrangedweapon", skill: "supersquirt", skillName:"Super Squirt", accuracy: 3, accmod: 0, damage: 0, stat: 0, dvmod: 0, damtype: "Chemical", element: " ", mode: {SA:"Semi-Automatic"}, rc: 0, rcmod: 0, ammo: 20, clip: "Clip", ap: 0, avail: 7, restrict: "Restricted", cost: 950, mods: {top: "empty", barrel: "n/a", under: "empty", internalsmart: "empty", integral: "n/a" }},
  fichettipaininducer: {name: "Fichetti Pain Inducer", active: false, category: "exoticrangedweapon", skill: "paininducer", skillName:"Pain Inducer", accuracy: 3, accmod: 0, damage: 0, stat: 0, dvmod: 0, damtype: "Special", element: " ", mode: {SS: "Single Shot"}, rc: 0, rcmod: 0, ammo: 10, clip: "Special", ap: 0, avail: 11, restrict: "Restricted", cost: 5000, mods: {top: "empty", barrel: "n/a", under: "empty", internalsmart: "empty", integral: "n/a" }},
  parashielddartpistol: {name: "Parashield Dart Pistol", active: false, category: "exoticrangedweapon", skill: "dartpistol", skillName:"Dart Pistol", accuracy: 5, accmod: 0, damage: 0, stat: 0, dvmod: 0, damtype: "Chemical", element: " ", mode: {SA:"Semi-Automatic"}, rc: 0, rcmod: 0, ammo: 5, clip: "Clip", ap: 0, avail: 4, restrict: "Restricted", cost: 600, mods: {top: "empty", barrel: "n/a", under: "n/a", internalsmart: "empty", integral: "n/a" }},
  parashielddartrifle: {name: "Parashield Dart Rifle", active: false, category: "exoticrangedweapon", skill: "dartrifle", skillName:"Dart Rifle", accuracy: 6, accmod: 0, damage: 0, stat: 0, dvmod: 0, damtype: "Chemical", element: " ", mode: {SA:"Semi-Automatic"}, rc: 0, rcmod: 0, ammo: 6, clip: "Internal Mag", ap: 0, avail: 6, restrict: "Restricted", cost: 1200, mods: {top: "empty", barrel: "n/a", under: "empty", internalsmart: "empty", integral: "Imaging Scope" }},
  grapplegun: {name: "Grapple Gun", active: false, category: "exoticrangedweapon", skill: "grapplegun", skillName:"Grapple Gun", accuracy: 3, accmod: 0, damage: 7, stat: 0, dvmod: 0, damtype: "Stun", element: "", mode: {SS:"Single Shot"}, rc: 0, rcmod: 0, ammo: 1, clip: "Muzzle-Loader", ap: -2, avail: 8, restrict: "Restricted", cost: 500, mods: {top: "empty", barrel: "empty", under: "empty", internalsmart: "empty", integral: "empty" }},
  microflarelauncher: {name: "Micro Flare Launcher", active: false, category: "exoticrangedweapon", skill: "microflarelauncher", skillName:"Micro Flare Launcher", accuracy: 3, accmod: 0, damage: 5, stat: 0, dvmod: 0, damtype: "Physical", element: "Fire", mode: {SS:"Single Shot"}, rc: 0, rcmod: 0, ammo: 1, clip: "Muzzle-Loader", ap: -5, avail: 0, restrict: "", cost: 175, mods: {top: "empty", barrel: "empty", under: "empty", internalsmart: "empty", integral: "empty" }},
...
var toxin = {
  ...
  neurostunviii: {name: "Neuro-Stun VIII", dose:0, vector:"Contact, Inhalation", speed: "1 Combat Turn", penetration:0, power: 12, effect: "Disorientation, Stun Damage", avail:12, restrict: "Restricted", cost: 60},
...
var electronics = {//This has more then just electronics in it now
  ...
  //RFID
  standardtag: {name:"Standard Tag", type:"rfid", device:1, avail:0, restrict:"", peritem: 10, cost:1},
  datachip: {name:"Datachip", type:"rfid", device:1, avail:0, restrict:"", peritem: 10, cost:5},
  securitytags: {name:"Security Tags", type:"rfid", device:3, avail:0, restrict:"", peritem: 10, cost:5},
  sensortags: {name:"Sensor Tags", type:"rfid", device:2, avail:5, restrict:"", peritem: 10, cost:40},
  stealthtags: {name:"Stealth Tags", type:"rfid", device:3, avail:7, restrict:"Restricted", peritem: 10, cost:10},

  //communications
  bugscanner: {name:"Bug Scanner", type:"communications", rating:1, ratingmax:6, availx:1, avail:1, restrict: "Restricted", costx:100, cost:100},//availx and costx are the multiplier for rating
  datatap: {name:"Data Tap", type:"communications", rating:"n/a", avail: 6, restrict:"Restricted", cost:300},
  headjammer: {name:"Headjammer", type:"communications", rating:1, ratingmax:6, availx:1, avail:1, restrict: "Restricted", costx:150, cost:150},
  jammerarea: {name:"Jammer, area", type:"communications", rating:1, ratingmax:6, availx:3, avail:3, restrict: "Forbidden", costx:200, cost:200},
  jammerdirectional: {name:"Jammer, directional", type:"communications", rating:1, ratingmax:6, availx:2, avail:2, restrict: "Forbidden", costx:200, cost:200},
  microtransciever: {name:"Micro-transciever", type:"communications", rating:"n/a", avail:2, restrict:"", costx:100, cost:100},
  tageraser: {name:"Tag eraser", type:"communications", rating:"n/a", avail:6, restrict: "Restricted", cost:450},
  whitenoisegenerator: {name:"White noise generator", type:"communications", rating:1, ratingmax:6, availx:1, avail:1, restrict:"", costx:50, cost:50},
...
//Tools
  toolkit: {name:"Kit", type:"tools", skill:"", avail:0, restrict:"", cost:500},
  toolshop: {name:"Shop", type:"tools", skill:"", avail:8, restrict:"", cost:5000},
  toolfacility: {name:"Facility", type:"tools", skill:"", avail:12, restrict:"", cost:50000},

//optical & imaging devices
  binoculars: {name:"Binoculars", type:"optics", rating:1, ratingmax:3, mods:["Vision Magnification"], avail:0, availx:0, restrict: "", costx:50, cost:50},
  binocularsoptical: {name:"Binoculars Opitcal", type:"optics", rating:"n/a", ratingmax:0, mods:["Vision Magnification"], avail:0, restrict: "", cost:50},
  camera: {name:"Camera", type:"optics", rating:1, ratingmax:6, mods:["Audio and Video Recording"], avail:0, availx:0, restrict: "", costx:100, cost:100},
  microcamera: {name:"Micro-Camera", type:"optics", rating:1, ratingmax:1, mods:["Audio and Video Recording"], avail:0, restrict: "", cost:100},
  contacts: {name:"Contacts", type:"optics", rating:1, ratingmax:3, avail:6, availx:0, restrict: "", costx:200, cost:200},
  glasses: {name:"Glasses", type:"optics", rating:1, ratingmax:4, avail:0, availx:0, restrict: "", costx:100, cost:100},
  goggles: {name:"Goggles", type:"optics", rating:1, ratingmax:6, avail:0, availx:0, restrict: "", costx:50, cost:50},
  monocle: {name:"Monocle", type:"optics", rating:1, ratingmax:4, avail:0, availx:0, restrict: "", costx:120, cost:120},
  endoscope: {name:"Endoscope", type:"optics", rating:"n/a", ratingmax:0, avail:8, restrict: "", cost:250},
  periscope: {name:"Periscope", type:"optics", rating:"n/a", ratingmax:0, avail:3, restrict: "", cost:50},
  magesightgoggles: {name:"Mage Sight Goggles", type:"optics", rating:"n/a", ratingmax:0, avail:3, restrict: "", cost:50},

//Audio Devices
  directionalmic: {name:"Directional Mic", type:"audio", rating:1, ratingmax:6, avail:4, availx:0, restrict:"", costx:50, cost:50},
  earbuds:{name:"Ear Buds", type:"audio", rating:1, ratingmax:3, avail:0, availx:0, restrict:"", costx:50, cost:50},
  headphones: {name:"Headphones", type:"audio", rating:1, ratingmax:6, avail:0, availx:0, restrict:"", costx:50, cost:50},
  lasermicrophone: {name:"Laser Microphone", type:"audio", rating:1, ratingmax:6, avail:6, availx:0, restrict:"Restricted", costx:100, cost:100},
  omnidirectionalmicrophone: {name:"Omni-Directional Microphone", type:"audio", rating:1, ratingmax:6, avail:0, availx:0, restrict:"", costx:50, cost:50},

//Security devices
  keycombinationlock: {name:"Key/combination lock", type:"securitydevice", rating:1, ratingmax:6, avail:1, availx:1, restrict:"", costx:10, cost:10},
  maglock: {name:"Maglock", type:"securitydevice", rating:1, ratingmax:6, maglockMods:{}, avail:1, availx:1, restrict:"", costx:100, cost:100},


//restraints
  metalrestraint: {name:"Metal", type:"restraints", armor:16, structure:2, avail:0, restrict:"", peritem: 1, cost:20},
  plasteelrestraint: {name:"Plasteel", type:"restraints", armor:20, structure:2, avail:6, restrict:"Restricted", peritem: 1, cost:50},
  plasticrestraint: {name:"Plastic (per 10)", type:"restraints",  armor:6, structure:1, avail:0, restrict:"", peritem: 10, cost:5},
  containmentmanacles: {name:"Containment manacles", type:"restraints",  armor:16, structure:2, avail:6, restrict:"Restricted", peritem: 1, cost:250},

//b&e gear
  autopicker: {name:"Autopicker", type:"bnegear", rating:1, ratingmax:6, avail:8, availx:0, restrict:"Restricted", costx:500, cost:500},
  cellularglovemolder: {name:"Cellular glove molder", type:"bnegear", rating:1, ratingmax:4, avail:12, availx:0, restrict:"Forbidden", costx:500, cost:500},
  chisel: {name:"Chisel", type:"bnegear", avail:0, restrict:"", cost:20},
  crowbar: {name:"Crowbar", type:"bnegear", avail:0, restrict:"", cost:20},
  keycardcopier: {name:"Keycard Copier", type:"bnegear", rating:1, ratingmax:6, avail:8, availx:0, restrict:"Forbidden", costx:600, cost:600},
  lockpickset: {name:"Lockpick set", type:"bnegear", avail:4, restrict:"Restricted", cost:250},
  maglockpasskey: {name:"Maglock passkey", type:"bnegear", rating:1, ratingmax:4, avail:3, availx:3, restrict:"Forbidden", costx:2000, cost:2000},
  ...
  sequencer: {name:"Sequencer", type:"bnegear", rating:1, ratingmax:6,  avail:3, availx:3, restrict:"Forbidden", costx:250, cost:250},
...
//industrial chemicals
  ...
  thermiteburningbar: {name:"Thermite burning bar", type:"chemicals", avail:16, restrict:"Restricted", cost:500},

//survival gear
  chemsuit: {name:"Chemsuit", type:"survivalgear", rating:1, ratingmax:6, avail:2, availx:2, restrict:"", costx:150, cost:150},
  ...
  respirator: {name:"Respirator", type:"survivalgear", rating:1, ratingmax:6, avail:0, availx:0, restrict:"", costx:50, cost:50},
...
//grapple gun gear
  ...
  catalyststick: {name:"Catalyst stick", type:"grapplegungear", avail:8, restrict:"Forbidden", cost:120},

//Grappling rope
  microwire: {name:"Microwire", type:"grapplerope", avail:4, restrict:"", peritem: 100, cost:50},
  myomericrope: {name:"Myomeric rope", type:"grapplerope", avail:10, restrict:"", peritem: 10, cost:200},
  standardrope: {name:"Standard rope", type:"grapplerope", avail:0, restrict:"", peritem: 100, cost:50},
  stealthrope: {name:"Stealth rope", type:"grapplerope", avail:8, restrict:"Forbidden", peritem: 100, cost:85},
...
//biotech
  ...
  medkit: {name:"Medkit", type:"biotech", rating:1, ratingmax:6, avail:1, availx:1, restrict:"", costx:250, cost:250},
  medkitsupplies: {name:"Medkit supplies", type:"biotech", avail:0, restrict:"", cost:100},

//docwagon contract
  basiccontract: {name:"Basic", type:"docwagon", avail:0, restrict:"", peritem: 1, cost:5000},
  goldontract: {name:"Gold", type:"docwagon", avail:0, restrict:"", peritem: 1, cost:25000},
  platinumontract: {name:"Platinum", type:"docwagon", avail:0, restrict:"", peritem: 1, cost:50000},
  superplatinumontract: {name:"Super-platinum", type:"docwagon", avail:0, restrict:"", peritem: 1, cost:100000},

//slap patches
  antidotepatch: {name:"Antidote patch", type:"slappatches", rating:1, ratingmax:6, avail:1, availx:1, restrict:"", costx:50, cost:50},
  chempatch: {name:"Chem patch", type:"slappatches", avail:6, restrict:"", cost:200},
  stimpatch: {name:"Stim patch", type:"slappatches", rating:1, ratingmax:6, avail:2, availx:2, restrict:"", costx:25, cost:25},
  tranqpatch: {name:"Tranq patch", type:"slappatches", rating:1, ratingmax:10, avail:2, availx:2, restrict:"", costx:20, cost:20},
  traumapatch: {name:"Trauma patch", type:"slappatches", avail:6, restrict:"", cost:500},

//magical items
  //enchanting foci
  alchemicalfocus: {name:"Alechemical Focus", type:"enchantingfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:5000, cost:5000, karmaCost:3},
  disenchantingfocus: {name:"Disenchanting Focus", type:"enchantingfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:5000, cost:5000, karmaCost:3},
  //metamagic foci
  centeringfocus: {name:"Centering Focus", type:"metamagicfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:9000, cost:9000, karmaCost:3},
  flexiblesignaturefocus: {name:"Flexible Signature Focus", type:"metamagicfoci", rating:1, ratingmax:6, restrict:"Restricted", avail:3, availx:3, costx:9000, cost:9000, karmaCost:3},
  maskingfocus: {name:"Masking Focus", type:"metamagicfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:9000, cost:9000, karmaCost:3},
  spellshapingfocus: {name:"Spell Shaping Focus", type:"metamagicfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:9000, cost:9000, karmaCost:3},
  //power foci
  powerfocifocus: {name:"Power Focus", type:"powerfoci", rating:1, ratingmax:6, avail:4, availx:4, restrict:"Restricted", costx:18000, cost:18000, karmaCost:6},
  //qi foci
  qifocus: {name:"Qi Focus", type:"qifoci", magicType:"adrenalineboost", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:3000, cost:3000, karmaCost:2},
  //spell foci
  counterspellingfocus: {name:"Counterspelling Focus", type:"spellfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, magicType:"Combat", karmaCost:2},
  ritualspellcastingfocus: {name:"Ritual Spellcasting Focus", type:"spellfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, magicType:"Anchored", karmaCost:2},
  spellcastingfocus: {name:"Spellcasting Focus", type:"spellfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, magicType:"Combat", karmaCost:2},
  sustainingfocus: {name:"Sustaining Focus", type:"spellfoci", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, magicType:"Combat", karmaCost:2},
  //spirit foci
  summoningfocus: {name:"Summoning Focus", type:"spiritfoci", magicType:"Air", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, karmaCost:2},
  banishingfocus: {name:"Banishing Focus", type:"spiritfoci", magicType:"Air", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, karmaCost:2},
  bindingfocus: {name:"Binding Focus", type:"spiritfoci", magicType:"Air", rating:1, ratingmax:6, avail:3, availx:3, restrict:"Restricted", costx:4000, cost:4000, karmaCost:2},
  //Magical Supplies
  magicallodgematerials: {name:"Magical Lodge Materials", type:"magicallodgematerials", rating:1, ratingmax:12, avail:2, availx:2, restrict:"", cost:500, costx:500},
...
var visionenhancements = {
  ...
  lowlightvision: {name:"Low-light vision", cap:1, avail:4, restricted: "", cost:500},
  flarecompensation: {name:"Flare Compensation", cap:1, avail:1, restricted: "", cost:250},
  imagelink: {name:"Image Link", cap:1, avail:0, restricted: "", cost:25},
  smartlink: {name:"Smartlink", cap:1, avail:4, restricted: "Restricted", cost:2000},
  thermographicvision: {name:"Thermographic Vision", cap:1, avail:6, restricted: "", cost:500},
...
var audioenhancements = {
  empty : {name:"Empty", avail:0, cost:0},
  audioenhancement1: {name:"Audio Enhancement 1", rating:1, cap:1, avail:2, restricted: "", cost:500},
  audioenhancement2: {name:"Audio Enhancement 2", rating:2, cap:2, avail:4, restricted: "", cost:1000},
  audioenhancement3: {name:"Audio Enhancement 3", rating:3, cap:3, avail:6, restricted: "", cost:1500},
...
var augmentations = {
  grade: {
    used:{cost:0.75, ess:1.25, avail:-4},
    standard:{cost:1, ess:1, avail:0},
    alpha:{cost:1.2, ess:0.8, avail:2},
    beta:{cost:1.5, ess:0.7, avail:4},
    delta:{cost:2.5, ess:0.5, avail:8}
  },
  obvious: {
    fullarm: {name:"Obvious Full Arm", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, armor:0, rc:0, essence:1, cap:0, capmax:15, avail:4, cost:15000},
    fullleg: {name:"Obvious Full Leg", grade:"standard", slot:"leg", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:1, cap:0, capmax:20, avail:4, cost:15000},
    hand: {name:"Obvious Hand", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.25, cap:0, capmax:4, avail:2, cost:5000},
    foot: {name:"Obvious Foot", grade:"standard", slot:"leg", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.25, cap:0, capmax:4, avail:2, cost:5000},
    lowerarm: {name:"Obvious Lower Arm", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.45, cap:0, capmax:10, avail:4, cost:10000},
    lowerleg: {name:"Obvious Lower Leg", grade:"standard", slot:"leg", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.45, cap:0, capmax:12, avail:4, cost:10000},
    torso: {name:"Obvious Torso", grade:"standard", slot:"chest", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:1.5, cap:0, capmax:10, avail:12, cost:20000},
    skull: {name:"Obvious Skull", grade:"standard", slot:"head", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.75, cap:0, capmax:4, avail:16, cost:10000}
  },
  synthetic: {
    fullarm: {name:"Synthetic Full Arm", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:1, cap:0, capmax:8, avail:4, cost:20000},
    fullleg: {name:"Synthetic Full Leg", grade:"standard", slot:"leg", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:1, cap:0, capmax:10, avail:4, cost:20000},
    hand: {name:"Synthetic Hand", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.25, cap:0, capmax:2, avail:2, cost:6000},
    foot: {name:"Synthetic Lower Arm", grade:"standard", slot:"arm", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.45, cap:0, capmax:5, avail:4, cost:12000},
    lowerleg: {name:"Synthetic Lower Leg", grade:"standard", slot:"leg", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.45, cap:0, capmax:6, avail:4, cost:12000},
    torso: {name:"Synthetic Torso", grade:"standard", slot:"chest", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:1.5, cap:0, capmax:5, avail:12, cost:25000},
    skull: {name:"Synthetic Skull", grade:"standard", slot:"head", str:3, augstr:0, agi:3, augagi:0, armor:0, rc:0, essence:0.75, cap:0, capmax:2, avail:16, cost:15000}
  },
  mods: {
    //limb enhancement
    enhancementagility: {name:"Enhancement Agility", type:"limb enhancement", stat:"agi", allow:["arm","leg","chest","head"], rating:0, ratingmax:3, capacity:0, avail:0, availx:3, restrict:"R", cost:0, costx:6500, ref:{book:"SR5", page:"456,457"}},
    enhancementarmor: {name:"Enhancement Armor", type:"limb enhancement", stat:"armor", allow:["arm","leg","chest","head"], rating:0, ratingmax:3, capacity:0, avail:0, availx:5, restrict:"", cost:0, costx:3000, ref:{book:"SR5", page:"456,457"}},
    enhancementstrength: {name:"Enhancement Strength", type:"limb enhancement", stat:"str", allow:["arm","leg","chest","head"], rating:0, ratingmax:3, capacity:0, avail:0, availx:3, restrict:"R", cost:0, costx:6500, ref:{book:"SR5", page:"456,457"}},

    //limb accessories
    cyberarmgyromount: {name:"Cyberarm Gyromount", type:"accessory", stat:"rc", allow:["arm"], rc:3, capacity:8, avail:12, restrict:"F", cost:6000, ref:{book:"SR5", page:"456,457"}},
  ...
  weapons: {
    holdoutpistol: {name:"Hold-Out Pistol", type:"cybergun", clip: false, laser: false, silencer: false, capacity:2, avail:8, restrict:"R", cost:2000, ref:{book:"SR5", page:"458"},
